...
//   const [finalsStart,    setFinalsStart]    = useState('') // Added: Dynamic Finals Date
//   const [semesterEnd,    setSemesterEnd]    = useState('') // Added: Dynamic End Date
...
//       finalsStart:   finalsStart, // Passing to API
//       semesterEnd:   semesterEnd,   // Passing to API
//       city:          city.trim() || 'New York'
//     })
//   }

//   // Logic to ensure the user provides all necessary temporal data
//   const isDetailsComplete = semesterStart && finalsStart && semesterEnd
...
//           initial={{ opacity: 0, y: 20 }}
//           animate={{ opacity: 1, y: 0 }}
//           className="flex flex-col items-center gap-6 max-w-sm w-full overflow-y-auto max-h-[80vh] py-4">
...
//             {/* Finals Start — Added for dynamic alerts */}
//             <div>
//               <p className="text-[10px] text-white/30 tracking-widest
//                             uppercase mb-2 px-1">
...
//               <input type="date"
//                 value={finalsStart}
//                 onChange={e => setFinalsStart(e.target.value)}
//                 className="w-full rounded-2xl px-5 py-3.5 text-sm
//                            text-white/80 focus:outline-none
//                            transition-colors"
//                 style={{
...
//             {/* Semester End — Added for dynamic alerts */}
//             <div>
//               <p className="text-[10px] text-white/30 tracking-widest
//                             uppercase mb-2 px-1">
//                 Semester End Date
...
//             </button>
//             <button
//               onClick={() => isDetailsComplete && setStep('tint')}
